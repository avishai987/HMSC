...
```{r}
volcano_plot.2(de_genes = acc_deg,fdr_cutoff = 0.05,fc_cutoff = 2, ident1 = "HMSC",ident2 = "ACC",top_genes_text = 5)
```
...
```{r}
library(reticulate)
virtualenv_create("cnmf_dev_2", packages = "install https://github.com/django/django/archive/master.zip")
use_condaenv("cnmf_env_dev", required = TRUE)
```
