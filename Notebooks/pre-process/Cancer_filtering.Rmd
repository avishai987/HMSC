...
```
```{r}
acc1_cancer_cells = AddMetaData(object = acc1_cancer_cells,metadata = original_counts,col.name = "reads") #from create_data_V1
comparisons <- list(c("1", "2"),c("2","3"))
VlnPlot(object = acc1_cancer_cells,group.by= "cor_cluster",features = "reads")+ stat_compare_means(comparisons = comparisons, label = "p.signif",label.y = 4e06)

acc1_cancer_cells = AddMetaData(object = acc1_cancer_cells,metadata = original_nfeatures,col.name = "genes_detected") #from create_data_V1
comparisons <- list(c("1", "2"),c("2","3"))
VlnPlot(object = acc1_cancer_cells,group.by= "cor_cluster",features = "genes_detected")+ stat_compare_means(comparisons = comparisons, label = "p.signif",label.y = 11000)
```
```{r}
VlnPlot(object = acc1_cancer_cells,group.by= "orig.ident",features = "reads")
VlnPlot(object = acc1_cancer_cells,group.by= "orig.ident",features = "genes_detected")
```
...
```
```{r}
saveRDS(object = acc1_cancer_15KnCount,file = "./Data/acc1_cancer_cells_15KnCount_V3.RDS")
```
...
acc_cancer_cells = acc_cancer_cells [,c(acc_cells_lst,hmsc_filtered_cells_lst)]
```
...
```
```{r}
saveRDS(object = acc_cancer_cells,file = "./Data/acc_cancer_cells_V4.RDS")
```
...
plt1 = VlnPlot(object = acc1_cancer_cells,group.by= "orig.ident",features = "reads")+ stat_compare_means(comparisons = comparisons, label = "p.signif",label.y = 4e06)
plt2 = VlnPlot(object = acc1_cancer_cells,group.by= "orig.ident",features = "genes_detected")+ stat_compare_means(comparisons = comparisons, label = "p.signif",label.y = 10000)
