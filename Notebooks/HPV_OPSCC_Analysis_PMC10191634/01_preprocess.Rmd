...
```{r}
#| Read data
matrix<-Matrix::readMM("./HPV_OPSCC_Analysis_PMC10191634/Data/10x_data/GSE182227_OPSCC.mtx.gz")
b1<-read.table("./HPV_OPSCC_Analysis_PMC10191634/Data/10x_data/GSE182227_barcodes.txt.gz")
g1<-read.table("./HPV_OPSCC_Analysis_PMC10191634/Data/10x_data/GSE182227_genes.txt.gz")
```
...
library(readxl)
metadata = read_excel(path = "./HPV_OPSCC_Analysis_PMC10191634/Data/NIHMS1892753-supplement-Supp_Tables.xlsx",
