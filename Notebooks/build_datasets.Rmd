...
ident = plyr::revalue(hmsc_acc_cancer@meta.data[["patient.ident"]], c("ACC1"="HMSC"))
hmsc_acc_cancer@meta.data[["patient.ident"]] <- ident
...
```
```{r}
DimPlot(hmsc_acc_cancer,pt.size = 1,group.by = "orig.ident")
```
```{r}
test = subset(hmsc_acc_cancer,subset = patient.ident == "HMSC")
