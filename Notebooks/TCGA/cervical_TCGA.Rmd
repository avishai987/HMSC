...
```{r fig.height=6, fig.width=8}
clinical_data_with_scores = clinical_data
clinical_data_with_scores$HPV_status   = if_else(
  condition = clinical_data_with_scores$submitter_id  %in% TCGA_HPV_data$submitter_id,
  true = "HPV+",
  false = "HPV-"
)
