...
```{r}
volcano_plt = volcano_plot(de_genes = acc_deg,fdr_cutoff = 0.05,fc_cutoff = 2, ident1 = "HMSC",ident2 = "ACC",top_genes_text = 0)
volcano_plt
```
...
dev.off()
```
volcano plot log2((mean TPM HPV+) - ( mean TPM HPV-))
