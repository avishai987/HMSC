...
library(reticulate)
use_virtualenv("/sci/labs/yotamd/lab_share/avishai.wizel/python_envs/Virtual_env/cnmf_dev/",required = T)
py_config() # if you see that r-reticulate has been loaded, restrat/terminate r and try again
...
adata = r.adata
(adata_c, adata_tp10k, hvgs) = p.preprocess_for_cnmf(adata, harmony_vars='orig.ident', n_top_rna_genes = 2000,max_scaled_thresh = 50, quantile_thresh = .9999,theta = 2, makeplots=True,save_output_base='./Data/cNMF/batch_corrected_cnmf/preprocess_output')
```
