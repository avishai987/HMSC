...
adata = r.adata
(adata_c, adata_tp10k, hvgs) = p.preprocess_for_cnmf(adata, harmony_vars='orig.ident', n_top_rna_genes = 2000,max_scaled_thresh = 50, quantile_thresh = .9999, makeplots=True,save_output_base='./Data/cNMF/batch_corrected_cnmf/batch_corrected_output')
```
