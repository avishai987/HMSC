...
```{r}
acc1_cancer_2500nFeatures <- FindVariableFeatures(acc1_cancer_2500nFeatures, selection.method = "vst", nfeatures = 15000)
acc1_cancer_2500nFeatures <- ScaleData(acc1_cancer_2500nFeatures, vars.to.regress = c("percent.mt","nCount_RNA"))
acc1_cancer_2500nFeatures <- RunPCA(acc1_cancer_2500nFeatures, features = VariableFeatures(object = acc1_cancer_2500nFeatures))
ElbowPlot(acc1_cancer_2500nFeatures) # checking the dimensionality 
```


```{r}
pc2use = 1:20
acc1_cancer_2500nFeatures <- FindNeighbors(acc1_cancer_2500nFeatures, dims = pc2use)
acc1_cancer_2500nFeatures <- FindClusters(acc1_cancer_2500nFeatures, resolution = 1)
acc1_cancer_2500nFeatures <- RunUMAP(acc1_cancer_2500nFeatures, dims = pc2use)
```

batch effect can be seen in UMAP:
```{r}
DimPlot(acc1_cancer_2500nFeatures,pt.size = 1,group.by = "orig.ident")
```
```{r}
...
# Update HMSC cells in other datasets
