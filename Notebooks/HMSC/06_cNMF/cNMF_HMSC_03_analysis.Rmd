...
all_metagenes = read.table(file = input$all_metagenes)
gep_scores = read.table(file = input$gep_scores)
...
```{r}
pdf(paste0(params$data_out_dir,"NMF_UMAP.pdf"),height = 8,width = 10)
p
dev.off()
...
```{r}
pdf(paste0(params$data_out_dir,"NMF_UMAP.pdf"),height = 7,width = 10)
p
dev.off()
...
```{r}
pdf(paste0(params$data_out_dir,"NMF_heatmap.pdf"),height = 10,width = 10)
p
dev.off()
