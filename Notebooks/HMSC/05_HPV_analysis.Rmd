...
params: 
  ...
  output_data: !r c(hmsc_deg_no_cc = "HMSC_hpv_deg_df.csv",
    hmsc_deg = "HMSC_hpv_deg_df_noG2M_cells.csv")
---
...
```{r}
write.csv(x  = hmsc_deg,file = paste0(params$data_out_dir,params$output_data["hmsc_deg_no_cc"]),row.names = T)
```
