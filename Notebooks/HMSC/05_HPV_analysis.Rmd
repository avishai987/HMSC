...
hmsc_cancer_cells = FindVariableFeatures(hmsc_cancer_cells,nfeatures = 15000,assay = "RNA")
features = VariableFeatures(hmsc_cancer_cells,assay = "RNA")
...
myb_tergets = myb_tergets[myb_tergets %in% features]
...
```{r echo = T, results = 'hide'}
features = hmsc_cancer_cells_ccFiltered@assays$RNA@data %>% rowMeans() %>% sort(decreasing = T) %>% head(3000) %>% names()

# hmsc_cancer_cells_ccFiltered = FindVariableFeatures(hmsc_cancer_cells_ccFiltered,nfeatures = 15000,assay = "RNA")
# features = VariableFeatures(hmsc_cancer_cells_ccFiltered,assay = "RNA")
