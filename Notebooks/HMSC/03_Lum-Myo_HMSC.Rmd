...
```{r}
pdf(paste0(params$figs_out_dir,"Luminal_genes_correlation.pdf"),height = 5,width = 10)
p
dev.off()
...
```
```{r}
pdf(paste0(params$figs_out_dir,"Myo_genes_correlation.pdf"),height = 5,width = 10)
p
dev.off()
...
```{r}
pdf(paste0(params$figs_out_dir,"Myo_genes_correlation_barplot.pdf"),height = 5,width = 10)
p
dev.off()
...
```{r}
pdf(paste0(params$figs_out_dir,"Luminal_genes_correlation_barplot.pdf"),height = 5,width = 10)
p
dev.off()
...
```{r}
high_notch =names(notch_scores[notch_scores>6])
myoscore = myoscore[!names(myoscore) == high_notch]
