...
```{r}
hmsc_acc_pri_cancer = FindVariableFeatures(hmsc_acc_pri_cancer,assay = "RNA",nfeatures = 15000)
...
data = as.data.frame(hmsc_acc_pri_cancer@assays$integrated@data[VariableFeatures(hmsc_acc_pri_cancer,assay = "RNA"),])
all_cells_pearson = cor(data)
