...
```{r}
library(biomaRt)
ensembl = useEnsembl(biomart="ensembl", dataset="hsapiens_gene_ensembl",host = "https://useast.ensembl.org/")
...
volcano_plt = volcano_plot(de_genes = acc_deg,fdr_cutoff = volcano_fdr,fc_cutoff = volcano_fc, ident1 = "HMSC",ident2 = "ACC",top_genes_text = 0)
volcano_plt
```
...
```{r}
write.csv2(x = acc_deg,file = paste0(params$data_out_dir,"HMSC_vs_ACC_DEG.csv"))
```