...
params: 
  ...
  input_data: !r c(all_cells = "./Reports/HMSC/01_preprocess/01_create_data/acc_tpm_nCount_mito_no146_15k_with_ACC1.RDS",
      ...
      acc_annotation_integrated =  "./Reports/HMSC/01_preprocess/02_Cancer_filtering/cell_types.RDS",
      gene_order_file= "./Input_data/CNV/gencode_v19_gene_pos.txt")
  output_data: NULL
...
# create annotation
acc_annotation_integrated  = readRDS(params$input_data["acc_annotation_integrated"])
...
infercnv_obj_default = infercnv::run(infercnv_obj, cutoff=1, out_dir=data_out_dir,
...
plot_cnv(infercnv_obj_default, output_format = "png",  write_expr_matrix = FALSE,out_dir = data_out_dir,png_res	=800,obs_title = "Malignant cells",ref_title = "Normal cells",contig_cex = 2, title = "Copy number variation")
untrace(infercnv:::get_group_color_palette)
```

```{r fig.height=8, fig.width=8,results='asis'}
print_tab(plt = knitr::include_graphics(paste0(data_out_dir,"/","infercnv.png"))
