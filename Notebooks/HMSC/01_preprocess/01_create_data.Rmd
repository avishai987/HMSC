...
new_dir_path = paste0("./Data_out/",script_name,"_",Sys.Date())
dir.create(new_dir_path)

# save objects
saveRDS(object = acc,file = paste0(new_dir_path,"/", "acc_tpm_nCount_mito_no146_15k_with_ACC1.RDS"))


rstudioapi::documentSave()
html_path = rstudioapi::getSourceEditorContext()$path  %>% gsub(pattern = "Rmd",replacement = "nb.html")
file.rename(from = html_path, 
            to = paste0(new_dir_path,"/",
  gsub(
