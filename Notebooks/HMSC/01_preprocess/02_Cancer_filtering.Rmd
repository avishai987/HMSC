...
acc_all_cells = readRDS("./Reports/HMSC/01_preprocess/01_create_data/acc_tpm_nCount_mito_no146_15k_with_ACC1.RDS")
```
...
saveRDS(cell_types,file = paste0(params$data_out_dir,"cell_types.RDS")) #save cell types for CNV
```
...
```{r}
saveRDS(object = acc_cancer_cells,file = paste0(params$data_out_dir,"acc_cancer_cells.RDS"))
```
