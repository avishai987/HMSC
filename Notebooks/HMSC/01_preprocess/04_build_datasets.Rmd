...
params: 
  ...
  input_data: !r c(
          acc1_cancer_cells = "./Reports/HMSC/01_preprocess/03_HMSC_cells_preprocess/acc1_cancer_cells_2500features_integrated_V5.RDS",
          cancer_cells = "./Reports/HMSC/01_preprocess/02_Cancer_filtering/acc_cancer_cells.RDS")
  output_data: c("hmsc_acc_pri_cancer_processed.RDS")
---         
...
```{r}
acc1_cancer_cells = readRDS("./Reports/HMSC/01_preprocess/03_HMSC_cells_preprocess/acc1_cancer_cells_2500features_integrated_V5.RDS")
cancer_cells = read_rds("./Reports/HMSC/01_preprocess/02_Cancer_filtering/acc_cancer_cells.RDS")
```
...
```{r}
file_name = paste0(params$data_out_dir,"hmsc_acc_pri_cancer_processed.RDS")
